...
def train_CNN(model, train_loader, test_loader, device, model_path, model_name, n_epochs=10, lr=0.01, alpha=1.0):
...
if __name__== "__main__":
    ...
    config = {
        ...
        "dropout": 0.3,
        "activation": nn.ELU,
        "model_name": "CNN_100k_asym_0.001", #used for saving the model and for wandb run name
    }
